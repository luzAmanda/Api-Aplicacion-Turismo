...
class AddForeignKeysToRoleUserTable extends Migration {
	...
	public function up()
	{
		Schema::table('role_user', function(Blueprint $table)
		{
			...
			$table->foreign('id_usuario', 'fk_role_use_reference_users')->references('id_usuario')->on('users')->onUpdate('RESTRICT')->onDelete('RESTRICT');
		});
	}
	...
	public function down()
	{
		Schema::table('role_user', function(Blueprint $table)
		{
			...
			$table->dropForeign('fk_role_use_reference_users');
		});
	}
