...
class AddForeignKeysToAdministradoresTable extends Migration {
	...
	public function up()
	{
		...
		{
			$table->foreign('id_usuario', 'fk_administ_reference_users')->references('id_usuario')->on('users')->onUpdate('RESTRICT')->onDelete('RESTRICT');
	...
	public function down()
	{
		Schema::table('administradores', function(Blueprint $table)
		{
			$table->dropForeign('fk_administ_reference_users');
